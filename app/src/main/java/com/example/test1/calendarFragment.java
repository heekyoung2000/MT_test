...
public class calendarFragment extends Fragment {
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return v;
        /*View v =inflater.inflate(R.layout.activity_calendar, container, false);
        v.findViewById(R.id.cha_Btn);
        v.findViewById(R.id.del_Btn);
        v.findViewById(R.id.save_Btn);
        v.findViewById(R.id.calendarItem);
        v.findViewById(R.id.calendarView);
        v.findViewById(R.id.diaryTextView);
        v.findViewById(R.id.textView2);
        v.findViewById(R.id.textView3);
        v.findViewById(R.id.contextEditText);
       return v;*/
